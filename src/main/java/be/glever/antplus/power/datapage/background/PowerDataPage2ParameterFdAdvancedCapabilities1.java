...
public class PowerDataPage2ParameterFdAdvancedCapabilities1 extends PowerDataPage2GetSetParameter {
    public static final byte SUBPAGE_NR = (byte) 0xFD;
    ...
    public byte getSubPageNumber() {
        return PowerDataPage2ParameterFdAdvancedCapabilities1.SUBPAGE_NR;
    }
