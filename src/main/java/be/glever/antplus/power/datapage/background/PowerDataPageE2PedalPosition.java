...
public class PowerDataPageE2PedalPosition extends AbstractPowerDataPage {
    public static final byte PAGE_NR = (byte) 0xE2;
    ...
    public byte getPageNumber() {
        return PowerDataPageE2PedalPosition.PAGE_NR;
    }
