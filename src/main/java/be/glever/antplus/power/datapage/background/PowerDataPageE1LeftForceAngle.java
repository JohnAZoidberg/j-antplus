...
public class PowerDataPageE1LeftForceAngle extends AbstractPowerDataPage {
    public static final byte PAGE_NR = (byte) 0xE1;
    ...
    public byte getPageNumber() {
        return PowerDataPageE1LeftForceAngle.PAGE_NR;
    }
