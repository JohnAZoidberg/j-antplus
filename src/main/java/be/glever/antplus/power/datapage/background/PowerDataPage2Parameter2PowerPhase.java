...
public class PowerDataPage2Parameter2PowerPhase extends PowerDataPage2GetSetParameter {
    public static final byte SUBPAGE_NR = 0x02;
    ...
    byte getSubPageNumber() {
        return PowerDataPage2Parameter2PowerPhase.SUBPAGE_NR;
    }
