...
public class PowerDataPage2ParameterFeAdvancedCapabilities2 extends PowerDataPage2GetSetParameter {
    public static final byte SUBPAGE_NR = (byte) 0xFE;
    ...
    public byte getSubPageNumber() {
        return PowerDataPage2ParameterFeAdvancedCapabilities2.SUBPAGE_NR;
    }
